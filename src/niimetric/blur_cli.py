...
def parse_args(args=None):
    parser = argparse.ArgumentParser(description="Add random blur to a NIfTI image using TorchIO.")
    ...
    parser.add_argument("-s", "--severity", type=int, choices=[1, 2, 3, 4, 5], default=3, help="Severity of blur (1-5). Default is 3.")
...
def main(args=None):
    ...
    blur_std = severity_map[parsed.severity]
